...
import about_img4 from "../Assets/Images/about_img_4.png";
        ...
        <div className="why_info_container mb-[4rem]">
          ...
          <div className="why_info">
            <ul>
              <li>
                <p>
                  <strong>Innovative Ecosystem:</strong> Combining the best of
              ...
              <li>
                <p>
                  <strong>High Growth Potential:</strong> With a projected
              ...
              <li>
                <p>
                  <strong>Early Bird Benefits:</strong> Join our presale to
